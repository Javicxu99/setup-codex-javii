...
avoidable developer friction. When `docs/compliance/eu-ai-act/` exists, run the deterministic
checker and report stale sources, missing classification/evidence, or escalation results.
